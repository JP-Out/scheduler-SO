...
def sjf_preemptive(processes, context_switch_time):
    ...
    completed = 0
    last_pid = None  # Mantém o ID do último processo executado
        ...
        if min_heap:
            ...
            if current_pid != last_pid:
                if last_pid is not None:
                    current_time += context_switch_time  # Adiciona o tempo de troca de contexto
            ...
            if burst_remaining[current_pid] == 0:  # Processo completado
                ...
                wait_times[current_pid] = end_times[current_pid] - current_process['arrival_time'] - current_process['burst_times'][0]  # Calcula o tempo de espera do processo
